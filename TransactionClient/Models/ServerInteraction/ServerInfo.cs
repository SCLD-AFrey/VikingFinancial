...
public class ServerInfo
{
    ...
    public void SetUnauthenticatedChannel(string p_target, ushort p_port, string p_userName = "")
    {
    ...
    public void SetAuthenticatedChannel(string p_token, string p_userName)
    {
